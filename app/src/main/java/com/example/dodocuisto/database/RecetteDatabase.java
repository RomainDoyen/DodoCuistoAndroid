...
public class RecetteDatabase {
    private SQLiteDatabase db;

    private IngredientDatabase ingredientDAO;
    private DirectionDatabase directionDAO;

    public RecetteDatabase(SQLiteDatabase db) {
        this.db = db;

        ingredientDAO = new IngredientDatabase(db);
        directionDAO = new DirectionDatabase(db);
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    public long insert(Recette recipe) {
    ...
    public List<Recette> selectAllByCategory(String category) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.N)
    public void update(Recette recipe) {
