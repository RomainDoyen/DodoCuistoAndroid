...
public class IngredientDatabase  {
    ...
    public IngredientDatabase(SQLiteDatabase db) {
        this.db = db;
    }
    ...
    public List<Ingredient> selectAllByRecipeId(long recipeId) {
        ...
        try (Cursor cursor = db.query(Config.TABLE_NAME,
            ...
            if (cursor.moveToFirst()) {
                do {
                    ingredients.add(new Ingredient(cursor.getLong(0), cursor.getString(1), cursor.getLong(2)));
    ...
    public static class Config {
        ...
        public static final String CREATE_TABLE_STATEMENT =
                "CREATE TABLE " + TABLE_NAME + " (" +
                        ...
                        "FOREIGN KEY(" + KEY_RECIPE_ID + ") REFERENCES " + RecetteDatabase.Config.TABLE_NAME + "(" + RecetteDatabase.Config.KEY_ID + "))";
    }
}
