...
public class IngredientController extends RecyclerView.Adapter<IngredientController.IngredientViewHolder> {
    private List<Ingredient> ingredientList;
    private boolean isEditable = true;
    private Context mContext;
    private IngredientListener ingredientListener;

    public IngredientController(Context context, List<Ingredient> ingredientList) {
        mContext = context;
        this.ingredientList = ingredientList;
    }

    public IngredientController(Context context, List<Ingredient> ingredientList, boolean isEditable) {
        mContext = context;
        this.ingredientList = ingredientList;
